...
* Using the left hand menu navigate to the alerting under the OpenSearch Plugins section. On the alerting page navigate to the destinations section, click on **Add destination**
...
4. Set up a Monitor aka. an Alert
* On the alerting page navigate to the Monitors, click on **Create monitor**
